...
const _MECHANICS := [
	...
	{"id": "block", "godotField": "block", "name": "Block", "shortName": "Block", "icon": "res://assets/ui/icons/mechanics/block.png", "tags": ["physical", "flat-reduction", "multi-hit-check"], "valueLabel": "blocked damage", "min": 0, "max": 300, "exportScale": 1, "baseCost": 9, "costPerValue": 2.9, "effectiveHpPerValue": 0.02, "poisonModifier": 0.12, "burstModifier": -0.16, "sustainedModifier": -0.2, "curves": {1: [1, 3], 2: [3, 6], 3: [5, 10], 4: [8, 14], 5: [12, 19], 6: [16, 23]}},
	...
	{"id": "absorb", "godotField": "absorb", "name": "Absorb", "shortName": "Absorb", "icon": "res://assets/ui/icons/mechanics/absorb.png", "tags": ["magical", "flat-reduction", "dot-check"], "valueLabel": "absorbed damage", "min": 0, "max": 250, "exportScale": 1, "baseCost": 9, "costPerValue": 3.2, "effectiveHpPerValue": 0.018, "poisonModifier": -0.3, "burstModifier": -0.04, "sustainedModifier": -0.16, "curves": {1: [1, 2], 2: [2, 4], 3: [3, 7], 4: [5, 10], 5: [8, 14], 6: [12, 18]}},
	{"id": "cleanse_threshold", "godotField": "cleanse_threshold", "name": "Cleanse", "shortName": "Cleanse", "icon": "res://assets/ui/icons/mechanics/cleanse.png", "tags": ["debuff", "cleanse", "poison-check"], "valueLabel": "attack threshold", "min": 1, "max": 10, "exportScale": 1, "invertCost": true, "baseCost": 18, "costPerValue": 5.2, "effectiveHpPerValue": 0.012, "poisonModifier": -0.42, "burstModifier": 0.08, "sustainedModifier": -0.1, "conflicts": ["poison_resistance"], "curves": {1: [8, 10], 2: [7, 9], 3: [6, 8], 4: [5, 7], 5: [4, 6], 6: [3, 5]}},
